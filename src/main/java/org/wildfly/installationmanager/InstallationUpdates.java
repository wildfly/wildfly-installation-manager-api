...
public class InstallationUpdates {
    ...
    private final List<ChannelVersionChange> channelUpdates;

    public InstallationUpdates(List<ArtifactChange> artifactUpdates, List<ChannelVersionChange> channelUpdates) {
        Objects.requireNonNull(artifactUpdates);
        Objects.requireNonNull(channelUpdates);

        this.artifactUpdates = Collections.unmodifiableList(artifactUpdates);
        this.channelUpdates = Collections.unmodifiableList(channelUpdates);
    }
     ...
     * @return list of changes or empty list if no changes found
     */
    public List<ChannelVersionChange> channelUpdates() {
